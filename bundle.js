...
/* harmony import */ var _ui_LottoView__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ui/LottoView */ "./src/js/ui/LottoView.js");

var lottoView = new _ui_LottoView__WEBPACK_IMPORTED_MODULE_0__["default"]();
...
/* harmony export */ });
/* harmony import */ var _constants_constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../constants/constants */ "./src/js/constants/constants.js");
/* harmony import */ var _domains_Lotto__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../domains/Lotto */ "./src/js/domains/Lotto.js");
/* harmony import */ var _validations_LottoMachine__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../validations/LottoMachine */ "./src/js/validations/LottoMachine.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var LottoMachine = /*#__PURE__*/function () {
  ...
  _createClass(LottoMachine, [{
    ...
    set: function set(money) {
      (0,_validations_LottoMachine__WEBPACK_IMPORTED_MODULE_2__["default"])(money);
    ...
    key: "lottoQuantity",
    get: function get() {
      return _classPrivateFieldGet(this, _inputMoney) / _constants_constants__WEBPACK_IMPORTED_MODULE_0__.LOTTO.PRICE;
    }
  }, {
    ...
    value: function generateLottos() {
      return Array(this.lottoQuantity).fill().map(function () {
        var lotto = new _domains_Lotto__WEBPACK_IMPORTED_MODULE_1__["default"]();
...
/* harmony export */ });
/* harmony import */ var _domains_LottoMachine__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../domains/LottoMachine */ "./src/js/domains/LottoMachine.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils */ "./src/js/ui/utils.js");
/* harmony import */ var _template__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./template */ "./src/js/ui/template.js");
...
var LottoView = /*#__PURE__*/function () {
  function LottoView() {
    ...
    this.machine = new _domains_LottoMachine__WEBPACK_IMPORTED_MODULE_0__["default"]();
  }

  _createClass(LottoView, [{
    key: "bindEvents",
    value: function bindEvents() {
      (0,_utils__WEBPACK_IMPORTED_MODULE_1__["default"])(_constants_constants__WEBPACK_IMPORTED_MODULE_3__.SELECTOR.ID.PURCHASE_MONEY_FORM).addEventListener('submit', this.handlePurchaseForm.bind(this));
      (0,_utils__WEBPACK_IMPORTED_MODULE_1__["default"])(_constants_constants__WEBPACK_IMPORTED_MODULE_3__.SELECTOR.ID.LOTTO_RESULT_TOGGLE).addEventListener('click', this.handleResultToggle.bind(this));
    }
  }, {
    ...
    value: function userInputMoney() {
      this.machine.inputMoney = Number((0,_utils__WEBPACK_IMPORTED_MODULE_1__["default"])(_constants_constants__WEBPACK_IMPORTED_MODULE_3__.SELECTOR.ID.PURCHASE_MONEY_INPUT).value);
    }
  }, {
    key: "renderLotto",
    value: function renderLotto() {
      (0,_utils__WEBPACK_IMPORTED_MODULE_1__["default"])(_constants_constants__WEBPACK_IMPORTED_MODULE_3__.SELECTOR.ID.LOTTO_RESULT_CONTAINER).replaceChildren();
      (0,_utils__WEBPACK_IMPORTED_MODULE_1__["default"])(_constants_constants__WEBPACK_IMPORTED_MODULE_3__.SELECTOR.ID.TOGGLE_CHECKBOX).checked ? this.renderLottoNumbers() : this.renderLottoImgs();
    }
  }, {
    key: "renderLottoImgs",
    value: function renderLottoImgs() {
      this.machine.lottos.map(function () {
        (0,_utils__WEBPACK_IMPORTED_MODULE_1__["default"])(_constants_constants__WEBPACK_IMPORTED_MODULE_3__.SELECTOR.ID.LOTTO_RESULT_CONTAINER).insertAdjacentHTML('beforeEnd', _template__WEBPACK_IMPORTED_MODULE_2__.ticketImg);
      });
    }
  }, {
    ...
    value: function renderLottoNumbers() {
      this.machine.lottos.map(function (lotto) {
        (0,_utils__WEBPACK_IMPORTED_MODULE_1__["default"])(_constants_constants__WEBPACK_IMPORTED_MODULE_3__.SELECTOR.ID.LOTTO_RESULT_CONTAINER).insertAdjacentHTML('beforeEnd', (0,_template__WEBPACK_IMPORTED_MODULE_2__.lottoNumberTemplate)(lotto.numbers.join(', ')));
      });
    }
  }, {
    key: "renderLottoAmount",
    value: function renderLottoAmount() {
      (0,_utils__WEBPACK_IMPORTED_MODULE_1__["default"])(_constants_constants__WEBPACK_IMPORTED_MODULE_3__.SELECTOR.ID.LOTTO_RESULT_SPAN).textContent = (0,_template__WEBPACK_IMPORTED_MODULE_2__.purchaseMessageTemplate)(this.machine.lottos);
    }
  }, {
    key: "disablePurchase",
    value: function disablePurchase() {
      (0,_utils__WEBPACK_IMPORTED_MODULE_1__["default"])(_constants_constants__WEBPACK_IMPORTED_MODULE_3__.SELECTOR.ID.PURCHASE_MONEY_INPUT).disabled = true;
      (0,_utils__WEBPACK_IMPORTED_MODULE_1__["default"])(_constants_constants__WEBPACK_IMPORTED_MODULE_3__.SELECTOR.ID.PURCHASE_MONEY_BUTTON).disabled = true;
    }
  }, {
    key: "showLottoContainers",
    value: function showLottoContainers() {
      (0,_utils__WEBPACK_IMPORTED_MODULE_1__["default"])(_constants_constants__WEBPACK_IMPORTED_MODULE_3__.SELECTOR.ID.LOTTO_RESULT_SECTION).hidden = false;
      (0,_utils__WEBPACK_IMPORTED_MODULE_1__["default"])(_constants_constants__WEBPACK_IMPORTED_MODULE_3__.SELECTOR.ID.WINNING_NUMBER_FORM).hidden = false;
    }
  }]);
...
function isValidUnit(money) {
  return money % _constants_constants__WEBPACK_IMPORTED_MODULE_0__.LOTTO.PRICE === 0;
}

function validateMoney(money) {
  if (!isValidUnit(money)) {
    throw new Error("".concat(_constants_constants__WEBPACK_IMPORTED_MODULE_0__.LOTTO.PRICE, "\uB2E8\uC704\uB85C \uC785\uB825\uD574\uC8FC\uC138\uC694"));
  }
